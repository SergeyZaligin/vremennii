...
module.exports.signup = async (req, res) => {
    ...
    let email = escapeHtml(req.body.email.trim());
    let nickname = escapeHtml(req.body.nickname.trim());
    let password = escapeHtml(req.body.password.trim());
    let repassword = escapeHtml(req.body.repassword.trim());
    let role = escapeHtml(req.body.role.trim());
