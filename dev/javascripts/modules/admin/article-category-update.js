(global => {
     ...
     */
    function ArticleCategoryUpdateHandler(selector) {
        if (!selector) {
    ...
    ArticleCategoryUpdateHandler.prototype.init = function () {
        if (this.selector) {
            ...
            this.selector.addEventListener('submit', e => {
                ...
                fetch('/admin/post/category/update', {
                    method: "post",
                    headers: {
    ...
    App.ArticleCategoryUpdateHandler = ArticleCategoryUpdateHandler;
    global.App = App;
